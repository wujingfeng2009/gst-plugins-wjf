...
gboolean type_reader_get_string_utf16 (TypeReader *reader, guint16 ** str);
gboolean type_reader_get_string_utf32 (TypeReader *reader, guint32 ** str);

gboolean type_reader_peek_string_utf8  (const TypeReader *reader, const gchar ** str);
gboolean type_reader_peek_string_utf16 (TypeReader *reader, guint16 ** str);
gboolean type_reader_peek_string_utf32 (TypeReader *reader, guint32 ** str);
...
{
  g_debug("type reader skip %d bytes unchecked!\n", nbytes);
  reader->byte += nbytes;
}
...
{ \
  g_debug("type reader peek " ##upper " date unchecked!\n");	\
...
{ \
  g_debug("type reader get " ##upper " date unchecked!\n");	\
...
{
  g_debug("type reader peek %d uint8 data unchecked!\n");
...
type_reader_get_data_unchecked (TypeReader *reader, guint size)
{
  ...
  g_debug("type reader get %d uint8 data unchecked!\n");
...
{
  g_debug("type reader dup %d uint8 data unchecked!\n");
...
{ \
  g_debug("type reader peek " ##name " date inline!\n");	\
...
{ \
  g_debug("type reader get " ##name " date inline!\n");	\
  g_return_val_if_fail (reader != NULL, FALSE); \
  g_return_val_if_fail (val != NULL, FALSE); \
  \
  if (_type_reader_get_remaining_unchecked (reader) < (bits / 8)) \
...
{
  g_debug("type reader dup %d uint8 data inline!\n");
  g_return_val_if_fail (reader != NULL, FALSE);
  g_return_val_if_fail (val != NULL, FALSE);
...
{
  g_debug("type reader get %d uint8 data inline!\n");
  g_return_val_if_fail (reader != NULL, FALSE);
  g_return_val_if_fail (val != NULL, FALSE);
...
{
  g_debug("type reader peek %d uint8 data inline!\n");
  g_return_val_if_fail (reader != NULL, FALSE);
  g_return_val_if_fail (val != NULL, FALSE);
